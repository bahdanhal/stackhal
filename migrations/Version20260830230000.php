...
final class Version20260830230000 extends AbstractMigration
{
    ...
    {
        return 'Update Composer license article to lead with empirical research findings and legal risk enforcement';
    }
...
HTML;
        ...
        $this->addSql(
            ...
            [
                ...
                $articleHtml,
                9,
                new \DateTimeImmutable('2026-08-30 23:00:00+00:00'),
